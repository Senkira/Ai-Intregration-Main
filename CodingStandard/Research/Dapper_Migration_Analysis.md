...
> **สำหรับโปรเจค RL Series ที่มีอยู่แล้ว → แนะนำ Option A: เปลี่ยน Dapper ทั้งหมด**
>
> **เหตุผล:**
...
> **สำหรับโปรเจคใหม่ → แนะนำ Option B: Hybrid**
>
> ใช้ EF Core Migration สำหรับ Schema Management  
> ใช้ Dapper สำหรับ Query ที่ต้องการ Performance

### Coding Standard ที่ต้องเพิ่มถ้าใช้ Dapper
...
| D.7 | ต้อง `AsNoTracking()` ทุก Query (ไม่มี Tracking ใน Dapper โดย Default) | ✅ N/A |
